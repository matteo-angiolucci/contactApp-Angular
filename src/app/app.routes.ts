...
import { LanguageChangeProjectComponent } from './language-change-project/language-change-project.component';
...
export const routes: Routes = [
  ...
  { path: 'languageProject' , component: LanguageChangeProjectComponent},
